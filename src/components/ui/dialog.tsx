  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <div
        ...
        style={{ paddingLeft: "calc(var(--sidebar-w, 0px) + 1rem)" }}
      >
        <DialogPrimitive.Content
          data-slot="dialog-content"
          data-size={size}
          className={cn(
            "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 relative z-50 grid w-full max-h-[88dvh] gap-4 rounded-lg border p-4 sm:p-6 shadow-lg duration-200 outline-none data-[size=default]:sm:max-w-lg data-[size=form]:sm:max-w-[720px] data-[size=mixed]:sm:max-w-[clamp(640px,72vw,920px)] data-[size=datagrid]:sm:max-w-[clamp(780px,72vw,1020px)] data-[size=wide]:sm:max-w-3xl data-[size=fullwidth]:sm:max-w-[92vw] data-[size=cloudsign]:w-full data-[size=cloudsign]:max-w-[1200px] data-[size=cloudsign]:p-0 data-[size=cloudsign]:gap-0",
            className
          )}
          {...props}
        >
