...
import { ContractStatusAlert } from "@/lib/contract-status/types";
import { ALERT_COLORS } from "@/lib/contract-status/constants";
...
interface ContractStatusAlertDialogProps {
...
export function ContractStatusAlertDialog({
  alerts,
  open,
  onOpenChange,
  note,
  ...
  onConfirm,
  loading,
}: ContractStatusAlertDialogProps) {
