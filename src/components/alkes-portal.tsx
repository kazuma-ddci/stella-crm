...
/**
 * ALKESブランドデザインコンポーネント
 * 外部パートナー向けポータルページ（ベンダー・BBS社等）で使用
 *
 * カラー: teal〜green グラデーション (#3b9d9d → #6fb789)
 * フォント: Noto Sans JP (既存のTailwind設定で適用)
 * 特徴: 角丸xl、ホバー上昇アニメ、グラデーションアクセント
 */
...
export function PortalLoginWrapper({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-[#f0faf5] px-4">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-[#f0faf5] text-[#3b9d9d] font-semibold border border-[#d1ede2]"
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-gray-400">
      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#3b9d9d]/10 to-[#6fb789]/10 flex items-center justify-center mb-4">
        <Icon className="h-8 w-8 text-[#3b9d9d]/60" />
      </div>
