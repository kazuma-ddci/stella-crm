 ...
 *   ?targetType=slp_company_record&targetId=123&entityName=○○
 * → 埋め込みセクションの「すべて表示」ボタンからの遷移先として機能。
 */
        ...
        <div>
          ...
          {isFiltered ? (
            <div className="mt-1 flex items-center gap-2 text-sm text-gray-600">
              ...
              <Link href="/slp/records/contact-histories-v2">
