...
import { addSlpAs, updateSlpAs, deleteSlpAs } from "./actions";
...
export function AsTable({ data, lineFriendOptions, staffOptions }: Props) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editing) {
        await updateSlpAs(editing.id, payload);
        toast.success("更新しました");
      } else {
        await addSlpAs(payload);
  ...
  return (
    <>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{editing ? "ASを編集" : "ASを追加"}</DialogTitle>
          </DialogHeader>
