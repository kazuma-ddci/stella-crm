...
export default async function SlpContactHistoryV2DetailPage({ params }: Props) {
  ...
  const history = await getContactHistoryV2ById(id, { projectCode: "stp" });
  if (!history) notFound();
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Link href={`/stp/records/contact-histories-v2/${history.id}/edit`}>
      ...
      <div>
        <Link
          href="/stp/records/contact-histories-v2"
