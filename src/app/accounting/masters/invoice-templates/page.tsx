...
import { InvoiceTemplatesTable } from "./invoice-templates-table";
...
export default async function InvoiceTemplatesPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">請求書テンプレート管理</h1>
      <Card>
        <CardHeader>
          <CardTitle>テンプレート一覧</CardTitle>
        </CardHeader>
        <CardContent>
          <InvoiceTemplatesTable data={data} companyOptions={companyOptions} />
        </CardContent>
      </Card>
    </div>
  );
