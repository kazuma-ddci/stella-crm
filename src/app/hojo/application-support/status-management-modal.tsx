...
type StatusType = "application" | "bbs";
...
const CONFIG = {
  ...
  bbs: {
    title: "BBSステータス管理",
    getAll: getAllBbsStatuses,
    add: addBbsStatus,
    update: updateBbsStatus,
    remove: deleteBbsStatus,
    reorder: reorderBbsStatuses,
  },
} as const;
...
export function StatusManagementModal({ open, onOpenChange, type = "application" }: Props) {
