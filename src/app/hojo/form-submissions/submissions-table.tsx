...
import { Pencil, AlertTriangle, CheckCircle2, Link2 } from "lucide-react";
            ...
            <TableBody>
              {data.map((r, i) => (
                <TableRow key={r.id} className="group/row">
                  ...
                  <TableCell className="text-xs text-muted-foreground">{r.wholesaleAccountId ?? "-"}</TableCell>
