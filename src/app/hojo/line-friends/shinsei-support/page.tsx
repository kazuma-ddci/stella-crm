...
export default async function ShinseiSupportLineFriendsPage() {
  const friends = await prisma.hojoLineFriendShinseiSupport.findMany({
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">申請サポートセンター — LINE友達情報</h1>
