...
export default async function AlkesLineFriendsPage() {
  const friends = await prisma.hojoLineFriendAlkes.findMany({
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">ALKES — LINE友達情報</h1>
