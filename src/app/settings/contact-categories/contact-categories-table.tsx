...
import { addContactCategory, updateContactCategory, deleteContactCategory, reorderContactCategories } from "./actions";
...
export function ContactCategoriesTable({ data, projectOptions, canEdit }: Props) {
  ...
  return (
    <CrudTable
      ...
      columns={columns}
      title="接触種別"
      onAdd={canEdit ? addContactCategory : undefined}
      onUpdate={canEdit ? updateContactCategory : undefined}
      onDelete={canEdit ? deleteContactCategory : undefined}
